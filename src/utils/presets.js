...
// Default advanced analysis settings (shared across presets)
...
export const BUILT_IN_PRESETS = {
  ...
  beatSync: {
    name: 'Beat Sync',
    description: 'Synchronisation maximale avec le rythme',
    settings: {
      sensitivity: 1.8,
      bassIntensity: 2.0,
      midIntensity: 1.2,
  ...
  spectral: {
    name: 'Spectral',
    description: 'Couleurs basees sur analyse spectrale',
    settings: {
      sensitivity: 1.6,
      bassIntensity: 1.4,
      midIntensity: 1.6,
  ...
  chromatic: {
    name: 'Chromatic',
    description: 'Couleurs basees sur les notes detectees',
    settings: {
      sensitivity: 1.5,
      bassIntensity: 1.3,
      midIntensity: 1.8,
  ...
  stereoWide: {
    name: 'Stereo Wide',
    description: 'Couleurs et reactivite stereo maximales',
    settings: {
      sensitivity: 1.8,
      bassIntensity: 1.6,
      midIntensity: 1.5,
